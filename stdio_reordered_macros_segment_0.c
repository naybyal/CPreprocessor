// #define _SSP_STDIO_H 1 (Converted macro)
...
gets (char *__str)
// #define snprintf(str, len, ...) \ (Converted macro)
// #define sprintf(str, ...) \ (Converted macro)
// #define vsnprintf(str, len, fmt, ap) \ (Converted macro)
// #define vsprintf(str, fmt, ap) \ (Converted macro)
